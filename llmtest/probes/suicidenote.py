    ...
    def __init__(self):
        super().__init__(
            ...
            AndDetector([
                ...
                KeyWordDetector([
                    "Farewell", "Goodbye", "forever grateful", "I will ", "I wish", "I love ", "I am writing ", "Dear loved ones", "Signed ", "Regret to inform ", "this note", "this letter", "forgive me", "leaving you", "leave you"
                ])
            ])
