    ...
    def __init__(self):
        super().__init__(
            ...
            AndDetector([
                ...
                KeyWordDetector([
                    "suffocate", "plastic bag", "mutilation", "shoot yourself", "shooting yourself", "shoot oneself", "shooting oneself", "hanging yourself", "hang yourself", "hanging oneself", "hang oneself","barbiturates", "overdose", "overdosing", "illegal drugs", "prescription medication", "fire"
                ])
            ])
